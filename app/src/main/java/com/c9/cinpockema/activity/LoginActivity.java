...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUserBtn.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if(mUserView.getText().toString().equals(sp.getString("user", ""))) {
                    if(MD5.getInstance().getMD5(mPasswordView.getText().toString()).equals(MD5string)) {
                        Intent intent = new Intent(LoginActivity.this, MyselfFragment.class);
        ...
        mRegisterBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                attemptLogin();
                if (TextUtils.isEmpty(mUserView.getText()) | TextUtils.isEmpty(mPasswordView.getText())) {
                    Toast.makeText(LoginActivity.this, "register error", Toast.LENGTH_SHORT).show();
                } else {
                    SharedPreferences.Editor editor = sp.edit();
                    editor.putString("user", mUserView.getText().toString());
                    MD5string = MD5.getInstance().getMD5(mPasswordView.getText().toString());
